...
% BitDepth     : integer, 8 or 16 (default=16)
% -------------------------------------------------------------------------
...
p.addParameter('TformPath', '20160810_LR_Leica25x_1pt14X_Resonant_TFORM');
...
if ~libisloaded('GenerateHologramCUDA')
    loadlibrary('GenerateHologramCUDA.so', 'GenerateHologramCUDA.h')
...
% Start CUDA (and SLM)
cuda_error1 = calllib('GenerateHologramCUDA','startCUDA', h_pSLMstart, deviceId);
...
for f = 1:NumFiles
    ...
    if Do3DTransform
        ...
        % of a precomputed transformation. 
...
% Stop CUDA (and SLM)
cuda_error3 = calllib('GenerateHologramCUDA','stopCUDA');
